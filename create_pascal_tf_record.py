...
parser.add_argument('--data_dir', type=str, default='C:/vmshared/xubuntu64/text_ds_final_6/',
...
parser.add_argument('--train_data_list', type=str, default='C:/vmshared/xubuntu64/text_ds_final_6/splits/train.txt',
                    help='Path to the file listing the training data.')

parser.add_argument('--valid_data_list', type=str, default='C:/vmshared/xubuntu64/text_ds_final_6/splits/test.txt',
                    help='Path to the file listing the validation data.')

parser.add_argument('--image_data_dir', type=str, default='pics',
                    help='The directory containing the image data.')

parser.add_argument('--label_data_dir', type=str, default='mask',
...
def main(unused_argv):
  ...
  train_output_path = os.path.join(FLAGS.output_path, 'txt_train.record')
  val_output_path = os.path.join(FLAGS.output_path, 'txt_val.record')
